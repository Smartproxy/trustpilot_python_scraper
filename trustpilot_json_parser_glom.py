...
def main():
    ...
    page_info = {  
        ...
        'CcategoryRank': categoryRank,
        'TopLevelDisplay Name': topLevelDisplayName,
        ...
        'VerifiedPayment Method': verifiedPaymentMethod,
        'HasCollected Incentivized Reviews': hasCollectedIncentivisedReviews,
        'Email': email,
        'Address': address,
        'City': city,
        'Country': country,
        ...
        'NumberOfFiltered Reviews': totalNumberOfFilteredReviews,
        ...
        'ThreeStarRatings Count': ratingsThreeStar,
        'FourStarRatings Count': ratingsFourStar,
        'FiveStarRatings Count': ratingsFiveStar
    }
